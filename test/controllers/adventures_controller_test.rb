...
class AdventuresControllerTest < ActionController::TestCase
  ...
  test "should create adventure" do
    assert_difference('Adventure.count') do
      post :create, adventure: { destination: @adventure.destination, time: @adventure.time, user_id: @adventure.user_id }
    end
  ...
  test "should update adventure" do
    patch :update, id: @adventure, adventure: { destination: @adventure.destination, time: @adventure.time, user_id: @adventure.user_id }
    assert_redirected_to adventure_path(assigns(:adventure))
  end
